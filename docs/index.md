# Rejesha Green Documentation

<div class="homepage-hero" markdown>

Digital tools for stronger forest communities
...
Rejesha Green transforms manual and paper-based forest-management processes into a centralized digital platform. It supports community registration, permit requests, illegal-activity reporting, conservation planning, and tree-restoration monitoring.

The platform is designed to improve communication, accountability, and collaboration between forest communities and forest-management authorities.
...
- **Member registration** for Community Forest Association members
- **Permit-request management** for forest-related activities
- **Illegal-activity reporting** through digital channels
- **Conservation planning** and restoration monitoring
- **SMS and USSD communication** for accessible user interaction
- **Mobile money payments** through M-Pesa
- **Role-based access control** for different platform users
- **Notifications and reminders** for important activities
...
- Community Forest Association officials
- CFA members and forest users
- KFS officials and forest rangers
- Backend and frontend developers
- System administrators and deployment teams
- Security reviewers and technical evaluators
...
!!! tip "For new readers"
    ...
    Start with the [Overview](overview.md) to understand the purpose, users, and goals of Rejesha Green.

!!! info "For technical teams"

    Read the [Architecture](architecture.md), [Backend](backend.md), and [Frontend](frontend.md) documentation to understand how the platform is designed and implemented.

!!! warning "For deployment teams"

    Review the [Security](security.md) and [Deployment](deployment.md) documentation before configuring a production environment.

---

## Documentation status

This documentation is actively maintained and updated as the Rejesha Green platform evolves.

If you identify missing information, outdated content, or a technical issue, report it to the project maintainers.
